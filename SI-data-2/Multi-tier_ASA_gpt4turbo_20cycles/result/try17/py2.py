...
def create_report():
    ...
    for N in [10, 50, 100, 200, 400]:
        ...
        document.add_picture(f'Chain3D{N}.�ng', width=Inches(4.25))
        
    document.add_paragraph(f'Figure 5: Mean Squared End-to-End Distance vs Number of Segments', style='Caption')
