...
def main():
    ...
    for N in N_values:
        ...
        selected_indices = np.random.randint(0, 2000, 50)  # select 50 random indices
        selected_chains = [all_chains[idx] for idx in selected_indices]
    ...
    plt.savefig('./plots/h_in_vs_N.png')
    plt.close()
